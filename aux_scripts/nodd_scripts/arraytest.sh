...
do
  ...
  do
    ...
    do	    
      ...
      echo $mem
      echo $flead
      echo wget -O $dest/gep${mem}.t${cyc}z.pgrb2a.0p50.f${flead} $url/gefs.20240319/${cyc}/atmos/pgrb2ap5/gep${mem}.t${cyc}z.pgrb2a.0p50.f${flead}
      wget -O $dest/gep${mem}.t${cyc}z.pgrb2a.0p50.f${flead} $url/gefs.20240319/${cyc}/atmos/pgrb2ap5/gep${mem}.t${cyc}z.pgrb2a.0p50.f${flead}
    done  
  done
done
