...
export PDY2m1=$(date -d "72 hours ago" '+%Y%m%d')
...
rsync -ahr -P /lfs/h2/emc/ptmp/emc.vpppg/evs/v1.0/plots/global_ens/atmos.${PDY2m1}/*naefs*.tar ssimon@emcrzdm.ncep.noaa.gov:/home/people/emc/www/htdocs/users/verification/global/naefs/para/tar_files/.
