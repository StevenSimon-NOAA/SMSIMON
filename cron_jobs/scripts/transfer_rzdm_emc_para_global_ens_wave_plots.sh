...
rsync -ahr -P /lfs/h2/emc/vpppg/noscrub/emc.vpppg/evs/v1.0/plots/global_ens/wave.${PDYm1}/*.tar ssimon@emcrzdm.ncep.noaa.gov:/home/people/emc/www/htdocs/users/verification/global/gefs/para/wave/tar_files/.
